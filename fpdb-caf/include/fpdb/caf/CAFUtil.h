...
public:
  ...
  inline static constexpr ::caf::type_id_t DeltaCacheKey_first_custom_type_id = ::caf::first_custom_type_id + 2600;
  inline static constexpr ::caf::type_id_t DeltaCacheData_first_custom_type_id = ::caf::first_custom_type_id + 2700;
  inline static constexpr ::caf::type_id_t DeltaCacheActor_first_custom_type_id = ::caf::first_custom_type_id + 2800;
  inline static constexpr ::caf::type_id_t KeepMapCacheKey_first_custom_type_id = ::caf::first_custom_type_id + 2900;
  inline static constexpr ::caf::type_id_t KeepMapCacheData_first_custom_type_id = ::caf::first_custom_type_id + 3000;
  inline static constexpr ::caf::type_id_t StableBmCacheKey_first_custom_type_id = ::caf::first_custom_type_id + 3100;
  inline static constexpr ::caf::type_id_t StableBmCacheData_first_custom_type_id = ::caf::first_custom_type_id + 3200;
};
