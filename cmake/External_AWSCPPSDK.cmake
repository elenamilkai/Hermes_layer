# AWS SDK
set(AWS_CPP_SDK_VERSION "1.9.100")
...
set(AWSCPPSDK_STS_SHARED_LIBS ${AWSCPPSDK_LIB_DIR}/${CMAKE_SHARED_LIBRARY_PREFIX}aws-cpp-sdk-sts${CMAKE_SHARED_LIBRARY_SUFFIX})
set(AWSCPPSDK_STS_STATIC_LIBS ${AWSCPPSDK_LIB_DIR}/${CMAKE_STATIC_LIBRARY_PREFIX}aws-cpp-sdk-sts${CMAKE_STATIC_LIBRARY_SUFFIX})
...
ExternalProject_Add(${AWSCPPSDK_BASE}
        ...
        BUILD_BYPRODUCTS ${AWSCPPSDK_CORE_SHARED_LIBS} ${AWSCPPSDK_CORE_STATIC_LIBS} ${AWSCPPSDK_S3_SHARED_LIBS} ${AWSCPPSDK_S3_STATIC_LIBS} ${AWSCPPSDK_STS_SHARED_LIBS} ${AWSCPPSDK_STS_STATIC_LIBS}
        CMAKE_ARGS
        -DBUILD_ONLY=s3;sts
        -DCPP_STANDARD=17
        -DENABLE_TESTING=OFF
...
set_target_properties("aws-cpp-sdk-sts" PROPERTIES IMPORTED_LOCATION ${AWSCPPSDK_STS_SHARED_LIBS})
target_include_directories("aws-cpp-sdk-sts" INTERFACE ${AWSCPPSDK_INCLUDE_DIR})
add_dependencies("aws-cpp-sdk-sts" ${AWSCPPSDK_BASE})
