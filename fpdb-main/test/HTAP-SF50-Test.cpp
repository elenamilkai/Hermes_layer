...
#define SCHEMA_PATH "hattrick-sf50/parquet/"
#define PARALLEL_DEGREE 1

TEST_SUITE("ssb-sf50-single_node-no-parallel" * doctest::skip(SKIP_SUITE)) {

  TEST_CASE("ssb-sf50-single_node-no-parallel-original" * doctest::skip(false || SKIP_SUITE)) {
