...
#ifndef __INCLUDE_DATE_D_HH_3481302679__H_
#define __INCLUDE_DATE_D_HH_3481302679__H_
...
struct date {
    ...
    std::string d_month;
    int64_t d_year;
    int64_t d_yearmonthnum;
    std::string d_yearmonth;
    int64_t d_daynuminweek;
    int64_t d_daynuminmonth;
    int64_t d_daynuminyear;
    int64_t d_monthnuminyear;
    int64_t d_weeknuminyear;
    ...
    date() :
        ...
        d_month(std::string()),
        d_year(int64_t()),
        d_yearmonthnum(int64_t()),
        d_yearmonth(std::string()),
        d_daynuminweek(int64_t()),
        d_daynuminmonth(int64_t()),
        d_daynuminyear(int64_t()),
        d_monthnuminyear(int64_t()),
        d_weeknuminyear(int64_t()),
